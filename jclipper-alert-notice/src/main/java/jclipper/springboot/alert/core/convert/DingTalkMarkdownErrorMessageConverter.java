 ...
 * @since 2021/12/6 16:41.
 */
public class DingTalkMarkdownErrorMessageConverter extends AbstractFormatMessageConverter implements MessageConverter {
    private static final String CONTENT_FORMAT = "### 【%s告警】\n- 时间: %s\n- 服务端: %s\n- 客户端: %s\n- 访问链接: %s\n- 追踪码: %s\n- 响应编码: %s\n- 消息: %s\n- 异常信息: \n> %s";


    static {
        DEFAULT_FORMAT.put(DingTalkMarkdownErrorMessageConverter.class.getName(), DingTalkMarkdownErrorMessageConverter.CONTENT_FORMAT);
    }
